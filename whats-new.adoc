...
summary: BlueXP의 온프레미스 ONTAP 클러스터 관리 기능이 새롭게 선보이는 기능에 대해 알아보십시오. 
---
...
[role="lead"]
BlueXP의 온프레미스 ONTAP 클러스터 관리 기능이 새롭게 선보이는 기능에 대해 알아보십시오.
...
https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-view-cluster-info.html["이 중요한 온프레미스 클러스터 정보를 확인하는 방법을 알아보십시오"]. 클러스터에 대한 NetApp NSS(Support Site Account)가 있어야 하며 NSS 자격 증명을 Cloud Manager 계정에 연결해야 합니다.
