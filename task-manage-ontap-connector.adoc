...
+
--
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["백업 및 복구 설명서"^]
...
+
--
https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["분류 문서"^]

--
데이터를 클라우드에 계층화:: ONTAP 클러스터에서 오브젝트 스토리지로 비활성 데이터를 자동으로 계층화하여 데이터 센터를 클라우드로 확장
+
--
https://docs.netapp.com/us-en/cloud-manager-tiering/concept-cloud-tiering.html["계층화 설명서"^]
